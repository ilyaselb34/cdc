...
Content: Completion of the time step for complete real data by linear interpolation, for the first try we will use the Enedis_SGE_HDM_A0622AU5.csv file
and we will correct the time step to be 30 minutes between each data point.
"""
...
with open(entry_path, "r", newline='', encoding='utf-8') as csv_file:
    ...
    # Reads the data and converts the date to datetime format and the power to integer
...
# Adds a time step column to the dataframe, showing the time difference between each data point
