...
Supposons que vous ayez un fichier de courbes de charges à étudier/corriger, nommé courbes_2023.csv et que vous souhaitiez mettre ces données au pas de temps horaire (une mesure toutes les 60 min).
...
```{bash, eval=FALSE}
python main.py --input_csv courbes_2023.csv --timestep 60
```
